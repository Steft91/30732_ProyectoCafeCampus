...
async function bootstrap() {
  ...
  // El filtro de excepciones se aplica con @UseFilters() en cada controlador
  // (no aqui con useGlobalFilters): Nest vincula los handlers de patron dentro
  // de connectMicroservice(), antes de que este codigo pueda registrar filtros
  // sobre la instancia devuelta, por lo que useGlobalFilters() nunca los alcanza.
